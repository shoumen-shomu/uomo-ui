...
const Cart = () => {
    ...
    const decrement = (item) => { if (item.quantity > 1) updateQuantity(item.id, item.quantity - 1); };
                    ...
                    <div className="flex flex-col lg:flex-row gap-10 items-start">
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <AnimatePresence mode="popLayout">
                                {cartItems.map((cart, index) => (
                                    ...
                                    >
                                        ...
                                        {/* Subtotal */}
                                        <span className="text-[14px] font-medium">${(cart.price * cart.quantity).toFixed(0)}</span>
                            ...
                            <div className="flex flex-col sm:flex-row justify-between gap-3 mt-6">
                                {/* Coupon */}
                                <div className="flex items-center border border-gray-300 rounded-sm overflow-hidden h-12 w-80">
                                    <input
                                        type="text"
