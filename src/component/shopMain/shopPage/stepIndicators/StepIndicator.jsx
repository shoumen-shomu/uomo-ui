      ...
      {steps.map((step, idx) => {
        ...
        return (
          <div
            ...
            style={{ flex: 1 }}
            className="relative pb-5 transition-all duration-200 text-head cursor-pointer"
          >
            ...
            <div className="flex items-baseline gap-2 hover:opacity-60 transition-opacity duration-200">
